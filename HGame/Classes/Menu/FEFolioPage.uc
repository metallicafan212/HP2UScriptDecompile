...
function Created()
{
  ...
  HarryCardBmp = UWindowButton(CreateWindow(Class'UWindowButton',480.0,50.0,128.0,128.0));
  HarryCardBmp.Register(self);
  HarryCardBmp.bDisabled = True;
  HarryCardBmp.bStretched = True;
  SmallCardBmp[0] = UWindowButton(CreateWindow(Class'UWindowButton',5.0,254,60.0,60.0));
  SmallCardBmp[1] = UWindowButton(CreateWindow(Class'UWindowButton',68.0,254.0,60.0,60.0));
  SmallCardBmp[2] = UWindowButton(CreateWindow(Class'UWindowButton',131.0,254.0,60.0,60.0));
  SmallCardBmp[3] = UWindowButton(CreateWindow(Class'UWindowButton',194.0,254.0,60.0,60.0));
  SmallCardBmp[4] = UWindowButton(CreateWindow(Class'UWindowButton',257.0,254.0,60.0,60.0));
  SmallCardBmp[5] = UWindowButton(CreateWindow(Class'UWindowButton',320.0,254.0,60.0,60.0));
  SmallCardBmp[6] = UWindowButton(CreateWindow(Class'UWindowButton',383.0,254.0,60.0,60.0));
  SmallCardBmp[7] = UWindowButton(CreateWindow(Class'UWindowButton',446.0,254.0,60.0,60.0));
  SmallCardBmp[8] = UWindowButton(CreateWindow(Class'UWindowButton',509.0,254.0,60.0,60.0));
  SmallCardBmp[9] = UWindowButton(CreateWindow(Class'UWindowButton',572.0,254.0,60.0,60.0));
  ...
  GoldButton = UWindowButton(CreateWindow(Class'UWindowButton',12.0,70.0,50.0,48.0));
  ...
  SilverButton = UWindowButton(CreateWindow(Class'UWindowButton',12.0,125.0,50.0,48.0));
  ...
  BronzeButton = UWindowButton(CreateWindow(Class'UWindowButton',12.0,180.0,50.0,48.0));
  ...
  ForwardButton = UWindowButton(CreateWindow(Class'UWindowButton',605.0,316.0,32.0,32.0));
  ...
  BackButton = UWindowButton(CreateWindow(Class'UWindowButton',5.0,316.0,32.0,32.0));
...
function HiliteCurrCard()
{
  if ( nCurrItemOnPage < ArrayCount(SmallCardBmp) )
  {
    ...
    nCardGlowLeft = HarryCardBmp.WinLeft + nCARDGLOW_BIG_OFFSET_X;
	nCardGlowTop = HarryCardBmp.WinTop + nCARDGLOW_BIG_OFFSET_Y;
...
function SetInitialSelection()
{
  ...
  if ( CurrCardGroup == CardGroup_Gold )
  {
    ...
    if ( nCardCount <= 1 * nCARDS_PER_SET )
    {
      nCurrPage = 0;
    } else //{
      if ( nCardCount <= 2 * nCARDS_PER_SET )
      {
        nCurrPage = 1;
      } else //{
        if ( nCardCount <= 3 * nCARDS_PER_SET )
        {
          nCurrPage = 2;
        } else //{
          if ( nCardCount <= 4 * nCARDS_PER_SET )
          {
            nCurrPage = 3;
          } else //{
            if ( nCardCount <= 5 * nCARDS_PER_SET )
            {
              nCurrPage = 4;
            }
          // }
