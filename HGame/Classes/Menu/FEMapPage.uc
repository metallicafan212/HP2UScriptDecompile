...
#exec Texture Import File=Textures\Icons\CircleTexture.PNG	GROUP=Icons	Name=CircleTexture COMPRESSION=3 UPSCALE=1 Mips=1 Flags=536870914
#exec Texture Import File=Textures\Icons\DiamondTexture.PNG	GROUP=Icons	Name=DiamondTexture COMPRESSION=3 UPSCALE=1 Mips=1 Flags=536870914
#exec Texture Import File=Textures\Icons\DiffindoTexture.PNG	GROUP=Icons	Name=DiffindoTexture COMPRESSION=3 UPSCALE=1 Mips=1 Flags=536870914
#exec Texture Import File=Textures\Icons\DownArrowTexture.PNG	GROUP=Icons	Name=DownArrowTexture COMPRESSION=3 UPSCALE=1 Mips=1 Flags=536870914
#exec Texture Import File=Textures\Icons\HarryLocationTexture.PNG	GROUP=Icons	Name=HarryLocationTexture COMPRESSION=3 UPSCALE=1 Mips=1 Flags=536870914
#exec Texture Import File=Textures\Icons\HexTexture.PNG	GROUP=Icons	Name=HexTexture COMPRESSION=3 UPSCALE=1 Mips=1 Flags=536870914
#exec Texture Import File=Textures\Icons\LeftArrowTexture.PNG	GROUP=Icons	Name=LeftArrowTexture COMPRESSION=3 UPSCALE=1 Mips=1 Flags=536870914
#exec Texture Import File=Textures\Icons\RectangleTexture.PNG	GROUP=Icons	Name=RectangleTexture COMPRESSION=3 UPSCALE=1 Mips=1 Flags=536870914
#exec Texture Import File=Textures\Icons\RictusempraTexture.PNG	GROUP=Icons	Name=RictusempraTexture COMPRESSION=3 UPSCALE=1 Mips=1 Flags=536870914
#exec Texture Import File=Textures\Icons\RightArrowTexture.PNG	GROUP=Icons	Name=RightArrowTexture COMPRESSION=3 UPSCALE=1 Mips=1 Flags=536870914
#exec Texture Import File=Textures\Icons\SkurgeTexture.PNG	GROUP=Icons	Name=SkurgeTexture COMPRESSION=3 UPSCALE=1 Mips=1 Flags=536870914
#exec Texture Import File=Textures\Icons\SquareGreenTexture.PNG	GROUP=Icons	Name=SquareGreenTexture COMPRESSION=3 UPSCALE=1 Mips=1 Flags=536870914
#exec Texture Import File=Textures\Icons\tSpongifyTexture.PNG	GROUP=Icons	Name=tSpongifyTexture COMPRESSION=3 UPSCALE=1 Mips=1 Flags=536870914
#exec Texture Import File=Textures\Icons\UpArrowTexture.PNG	GROUP=Icons	Name=UpArrowTexture COMPRESSION=3 UPSCALE=1 Mips=1 Flags=536870914
