...
function PreBeginPlay()
{
  ...
  fGrowTime *= RandRange(0.80,1.20);
  if ( FRand() > 0.75 )
  {
    switch (Rand(6))
    {
      case 0:
      PlaySound(Sound'ss_COS_venomland_01E',,RandRange(0.30,0.60),,,RandRange(0.80,1.20));
      break;
      case 1:
      PlaySound(Sound'ss_COS_venomland_05E',,RandRange(0.30,0.60),,,RandRange(0.80,1.20));
      break;
      case 2:
      PlaySound(Sound'ss_COS_venomland_04E',,RandRange(0.30,0.60),,,RandRange(0.80,1.20));
      break;
      case 3:
      PlaySound(Sound'ss_COS_venomland_03E',,RandRange(0.30,0.60),,,RandRange(0.80,1.20));
      break;
      case 4:
      PlaySound(Sound'ss_COS_venomland_02E',,RandRange(0.30,0.60),,,RandRange(0.80,1.20));
      break;
      case 5:
      PlaySound(Sound'ss_COS_venomland_06E',,RandRange(0.30,0.60),,,RandRange(0.80,1.20));
      break;
      default:
    }
  }
