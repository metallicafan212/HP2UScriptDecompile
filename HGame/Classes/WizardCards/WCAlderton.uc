...
#exec Texture Import File=Textures\Icons\WizCardAldertonBigTexture.PNG	GROUP=Icons	Name=WizCardAldertonBigTexture COMPRESSION=3 UPSCALE=1 Mips=0 Flags=2
