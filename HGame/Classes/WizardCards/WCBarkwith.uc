...
#exec Texture Import File=Textures\Icons\WizCardBarkwithBigTexture.PNG	GROUP=Icons	Name=WizCardBarkwithBigTexture COMPRESSION=3 UPSCALE=1 Mips=0 Flags=2
