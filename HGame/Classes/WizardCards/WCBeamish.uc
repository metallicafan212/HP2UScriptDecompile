...
#exec Texture Import File=Textures\Icons\WizCardBeamishBigTexture.PNG	GROUP=Icons	Name=WizCardBeamishBigTexture COMPRESSION=P8 UPSCALE=1 Mips=0 Flags=2
