...
#exec Texture Import File=Textures\Icons\WizCardCatchloveBigTexture.PNG	GROUP=Icons	Name=WizCardCatchloveBigTexture COMPRESSION=3 UPSCALE=1 Mips=1 Flags=2
