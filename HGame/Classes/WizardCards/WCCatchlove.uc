...
#exec Texture Import File=Textures\Icons\WizCardCatchloveBigTexture.PNG	GROUP=Icons	Name=WizCardCatchloveBigTexture COMPRESSION=P8 UPSCALE=1 Mips=0 Flags=2
