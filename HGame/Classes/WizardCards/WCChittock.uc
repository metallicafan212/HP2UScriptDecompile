...
#exec Texture Import File=Textures\Icons\WizCardChittockBigTexture.PNG	GROUP=Icons	Name=WizCardChittockBigTexture COMPRESSION=3 UPSCALE=1 Mips=1 Flags=2
