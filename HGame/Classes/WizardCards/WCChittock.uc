...
#exec Texture Import File=Textures\Icons\WizCardChittockBigTexture.PNG	GROUP=Icons	Name=WizCardChittockBigTexture COMPRESSION=P8 UPSCALE=1 Mips=0 Flags=2
