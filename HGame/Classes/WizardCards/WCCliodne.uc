...
#exec Texture Import File=Textures\Icons\WizCardCliodneBigTexture.PNG	GROUP=Icons	Name=WizCardCliodneBigTexture COMPRESSION=P8 UPSCALE=1 Mips=0 Flags=2
