...
#exec Texture Import File=Textures\Icons\WizCardDodderidgeBigTexture.PNG	GROUP=Icons	Name=WizCardDodderidgeBigTexture COMPRESSION=3 UPSCALE=1 Mips=0 Flags=2
