...
#exec Texture Import File=Textures\Icons\WizCardDumbledoreBigTexture.PNG	GROUP=Icons	Name=WizCardDumbledoreBigTexture COMPRESSION=3 UPSCALE=1 Mips=0 Flags=2
#exec Texture Import File=Textures\Icons\WizCardAlbusBigTextureLayer0.PNG	GROUP=Icons	Name=WizCardAlbusBigTextureLayer0 COMPRESSION=3 UPSCALE=1 Mips=0 Flags=2
#exec Texture Import File=Textures\Icons\WizCardAlbusBigTextureLayer1.PNG	GROUP=Icons	Name=WizCardAlbusBigTextureLayer1 COMPRESSION=3 UPSCALE=1 Mips=0 Flags=2
#exec Texture Import File=Textures\Icons\WizCardAlbusBigTextureLayer2.PNG	GROUP=Icons	Name=WizCardAlbusBigTextureLayer2 COMPRESSION=3 UPSCALE=1 Mips=0 Flags=2
