...
#exec Texture Import File=Textures\Icons\WizCardElphickBigTexture.PNG	GROUP=Icons	Name=WizCardElphickBigTexture COMPRESSION=P8 UPSCALE=1 Mips=0 Flags=2
