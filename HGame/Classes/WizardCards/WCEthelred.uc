...
#exec Texture Import File=Textures\Icons\WizCardEthelredBigTexture.PNG	GROUP=Icons	Name=WizCardEthelredBigTexture COMPRESSION=3 UPSCALE=1 Mips=1 Flags=2
