...
#exec Texture Import File=Textures\Icons\WizCardFancourtBigTexture.PNG	GROUP=Icons	Name=WizCardFancourtBigTexture COMPRESSION=3 UPSCALE=1 Mips=0 Flags=2
