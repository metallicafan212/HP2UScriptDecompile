...
#exec Texture Import File=Textures\Icons\WizCardFurmageBigTexture.PNG	GROUP=Icons	Name=WizCardFurmageBigTexture COMPRESSION=P8 UPSCALE=1 Mips=0 Flags=2
