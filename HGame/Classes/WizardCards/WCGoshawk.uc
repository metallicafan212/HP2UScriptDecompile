...
#exec Texture Import File=Textures\Icons\WizCardGoshawkBigTexture.PNG	GROUP=Icons	Name=WizCardGoshawkBigTexture COMPRESSION=P8 UPSCALE=1 Mips=0 Flags=2
