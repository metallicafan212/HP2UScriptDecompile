...
#exec Texture Import File=Textures\Icons\WizCardGregoryBigTexture.PNG	GROUP=Icons	Name=WizCardGregoryBigTexture COMPRESSION=P8 UPSCALE=1 Mips=0 Flags=2
