...
#exec Texture Import File=Textures\Icons\WizCardGryffindorBigTexture.PNG	GROUP=Icons	Name=WizCardGryffindorBigTexture COMPRESSION=3 UPSCALE=1 Mips=0 Flags=2
