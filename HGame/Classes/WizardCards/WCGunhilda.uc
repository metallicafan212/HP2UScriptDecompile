...
#exec Texture Import File=Textures\Icons\WizCardGunhildaBigTexture.PNG	GROUP=Icons	Name=WizCardGunhildaBigTexture COMPRESSION=3 UPSCALE=1 Mips=1 Flags=2
