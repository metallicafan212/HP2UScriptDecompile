...
#exec Texture Import File=Textures\Icons\WizCardGunhildaBigTexture.PNG	GROUP=Icons	Name=WizCardGunhildaBigTexture COMPRESSION=P8 UPSCALE=1 Mips=0 Flags=2
