...
#exec Texture Import File=Textures\Icons\WizCardHipworthBigTexture.PNG	GROUP=Icons	Name=WizCardHipworthBigTexture COMPRESSION=P8 UPSCALE=1 Mips=0 Flags=2
