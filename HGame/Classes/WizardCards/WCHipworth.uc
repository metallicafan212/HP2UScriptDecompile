...
#exec Texture Import File=Textures\Icons\WizCardHipworthBigTexture.PNG	GROUP=Icons	Name=WizCardHipworthBigTexture COMPRESSION=3 UPSCALE=1 Mips=1 Flags=2
