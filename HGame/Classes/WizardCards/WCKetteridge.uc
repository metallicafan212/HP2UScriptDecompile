...
#exec Texture Import File=Textures\Icons\WizCardKetteridgeBigTexture.PNG	GROUP=Icons	Name=WizCardKetteridgeBigTexture COMPRESSION=P8 UPSCALE=1 Mips=0 Flags=2
