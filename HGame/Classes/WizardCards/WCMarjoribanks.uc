...
#exec Texture Import File=Textures\Icons\WizCardMarjoribanksBigTexture.PNG	GROUP=Icons	Name=WizCardMarjoribanksBigTexture COMPRESSION=3 UPSCALE=1 Mips=0 Flags=2
