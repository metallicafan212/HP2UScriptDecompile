...
#exec Texture Import File=Textures\Icons\WizCardMarjoribanksBigTexture.PNG	GROUP=Icons	Name=WizCardMarjoribanksBigTexture COMPRESSION=3 UPSCALE=1 Mips=1 Flags=2
