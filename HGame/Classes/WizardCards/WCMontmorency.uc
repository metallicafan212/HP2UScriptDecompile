...
#exec Texture Import File=Textures\Icons\WizCardMontmorencyBigTexture.PNG	GROUP=Icons	Name=WizCardMontmorencyBigTexture COMPRESSION=P8 UPSCALE=1 Mips=0 Flags=2
