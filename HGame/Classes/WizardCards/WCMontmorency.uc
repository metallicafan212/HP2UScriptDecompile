...
#exec Texture Import File=Textures\Icons\WizCardMontmorencyBigTexture.PNG	GROUP=Icons	Name=WizCardMontmorencyBigTexture COMPRESSION=3 UPSCALE=1 Mips=1 Flags=2
