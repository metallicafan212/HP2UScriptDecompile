...
#exec Texture Import File=Textures\Icons\WizCardMuldoonBigTexture.PNG	GROUP=Icons	Name=WizCardMuldoonBigTexture COMPRESSION=P8 UPSCALE=1 Mips=0 Flags=2
