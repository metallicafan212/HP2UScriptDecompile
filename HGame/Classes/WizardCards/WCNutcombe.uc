...
#exec Texture Import File=Textures\Icons\WizCardNutcombeBigTexture.PNG	GROUP=Icons	Name=WizCardNutcombeBigTexture COMPRESSION=3 UPSCALE=1 Mips=1 Flags=2
