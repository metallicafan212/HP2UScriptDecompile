...
#exec Texture Import File=Textures\Icons\WizCardOglethorpeBigTexture.PNG	GROUP=Icons	Name=WizCardOglethorpeBigTexture COMPRESSION=3 UPSCALE=1 Mips=0 Flags=2
