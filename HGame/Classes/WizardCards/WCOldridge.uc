...
#exec Texture Import File=Textures\Icons\WizCardOldridgeBigTexture.PNG	GROUP=Icons	Name=WizCardOldridgeBigTexture COMPRESSION=3 UPSCALE=1 Mips=0 Flags=2
