...
#exec Texture Import File=Textures\Icons\WizCardOldridgeBigTexture.PNG	GROUP=Icons	Name=WizCardOldridgeBigTexture COMPRESSION=3 UPSCALE=1 Mips=1 Flags=2
