...
#exec Texture Import File=Textures\Icons\WizCardOliphantBigTexture.PNG	GROUP=Icons	Name=WizCardOliphantBigTexture COMPRESSION=3 UPSCALE=1 Mips=0 Flags=2
