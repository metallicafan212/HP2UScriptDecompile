...
#exec Texture Import File=Textures\Icons\WizCardOllertonBigTexture.PNG	GROUP=Icons	Name=WizCardOllertonBigTexture COMPRESSION=P8 UPSCALE=1 Mips=0 Flags=2
