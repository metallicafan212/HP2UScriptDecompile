...
#exec Texture Import File=Textures\Icons\WizCardParacelsusBigTexture.PNG	GROUP=Icons	Name=WizCardParacelsusBigTexture COMPRESSION=3 UPSCALE=1 Mips=1 Flags=2
