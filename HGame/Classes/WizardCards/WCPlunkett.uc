...
#exec Texture Import File=Textures\Icons\WizCardPlunkettBigTexture.PNG	GROUP=Icons	Name=WizCardPlunkettBigTexture COMPRESSION=P8 UPSCALE=1 Mips=0 Flags=2
