...
#exec Texture Import File=Textures\Icons\WizCardPlunkettBigTexture.PNG	GROUP=Icons	Name=WizCardPlunkettBigTexture COMPRESSION=3 UPSCALE=1 Mips=1 Flags=2
