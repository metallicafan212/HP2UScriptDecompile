...
#exec Texture Import File=Textures\Icons\WizCardRastrickBigTexture.PNG	GROUP=Icons	Name=WizCardRastrickBigTexture COMPRESSION=3 UPSCALE=1 Mips=0 Flags=2
