...
#exec Texture Import File=Textures\Icons\WizCardRastrickBigTexture.PNG	GROUP=Icons	Name=WizCardRastrickBigTexture COMPRESSION=3 UPSCALE=1 Mips=1 Flags=2
