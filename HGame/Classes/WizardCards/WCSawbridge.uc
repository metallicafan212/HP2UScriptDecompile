...
#exec Texture Import File=Textures\Icons\WizCardSawbridgeBigTexture.PNG	GROUP=Icons	Name=WizCardSawbridgeBigTexture COMPRESSION=3 UPSCALE=1 Mips=1 Flags=2
