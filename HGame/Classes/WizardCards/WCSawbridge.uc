...
#exec Texture Import File=Textures\Icons\WizCardSawbridgeBigTexture.PNG	GROUP=Icons	Name=WizCardSawbridgeBigTexture COMPRESSION=P8 UPSCALE=1 Mips=0 Flags=2
