...
#exec Texture Import File=Textures\Icons\WizCardScamanderBigTexture.PNG	GROUP=Icons	Name=WizCardScamanderBigTexture COMPRESSION=3 UPSCALE=1 Mips=0 Flags=2
