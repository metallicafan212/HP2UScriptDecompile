...
#exec Texture Import File=Textures\Icons\WizCardShimplingBigTexture.PNG	GROUP=Icons	Name=WizCardShimplingBigTexture COMPRESSION=3 UPSCALE=1 Mips=0 Flags=2
