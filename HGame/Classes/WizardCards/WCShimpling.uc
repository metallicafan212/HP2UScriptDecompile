...
#exec Texture Import File=Textures\Icons\WizCardShimplingBigTexture.PNG	GROUP=Icons	Name=WizCardShimplingBigTexture COMPRESSION=P8 UPSCALE=1 Mips=0 Flags=2
