...
#exec Texture Import File=Textures\Icons\WizCardShingletonBigTexture.PNG	GROUP=Icons	Name=WizCardShingletonBigTexture COMPRESSION=3 UPSCALE=1 Mips=1 Flags=2
