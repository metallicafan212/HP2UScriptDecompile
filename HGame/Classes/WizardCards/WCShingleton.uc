...
#exec Texture Import File=Textures\Icons\WizCardShingletonBigTexture.PNG	GROUP=Icons	Name=WizCardShingletonBigTexture COMPRESSION=3 UPSCALE=1 Mips=0 Flags=2
