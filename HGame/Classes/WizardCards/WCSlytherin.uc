...
#exec Texture Import File=Textures\Icons\WizCardSlytherinBigTexture.PNG	GROUP=Icons	Name=WizCardSlytherinBigTexture COMPRESSION=P8 UPSCALE=1 Mips=0 Flags=2
