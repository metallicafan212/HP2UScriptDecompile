...
#exec Texture Import File=Textures\Icons\WizCardSmethwyckBigTexture.PNG	GROUP=Icons	Name=WizCardSmethwyckBigTexture COMPRESSION=3 UPSCALE=1 Mips=1 Flags=2
