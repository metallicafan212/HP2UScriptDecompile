...
#exec Texture Import File=Textures\Icons\WizCardStarkeyBigTexture.PNG	GROUP=Icons	Name=WizCardStarkeyBigTexture COMPRESSION=P8 UPSCALE=1 Mips=0 Flags=2
