...
#exec Texture Import File=Textures\Icons\WizCardStroulgerBigTexture.PNG	GROUP=Icons	Name=WizCardStroulgerBigTexture COMPRESSION=P8 UPSCALE=1 Mips=0 Flags=2
