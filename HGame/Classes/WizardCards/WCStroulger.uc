...
#exec Texture Import File=Textures\Icons\WizCardStroulgerBigTexture.PNG	GROUP=Icons	Name=WizCardStroulgerBigTexture COMPRESSION=3 UPSCALE=1 Mips=1 Flags=2
