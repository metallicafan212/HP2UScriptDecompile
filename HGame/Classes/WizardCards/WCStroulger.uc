...
#exec Texture Import File=Textures\Icons\WizCardStroulgerBigTexture.PNG	GROUP=Icons	Name=WizCardStroulgerBigTexture COMPRESSION=3 UPSCALE=1 Mips=0 Flags=2
