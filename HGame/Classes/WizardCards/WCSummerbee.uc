...
#exec Texture Import File=Textures\Icons\WizCardSummerbeeBigTexture.PNG	GROUP=Icons	Name=WizCardSummerbeeBigTexture COMPRESSION=3 UPSCALE=1 Mips=0 Flags=2
