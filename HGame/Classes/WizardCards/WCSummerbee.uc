...
#exec Texture Import File=Textures\Icons\WizCardSummerbeeBigTexture.PNG	GROUP=Icons	Name=WizCardSummerbeeBigTexture COMPRESSION=3 UPSCALE=1 Mips=1 Flags=2
