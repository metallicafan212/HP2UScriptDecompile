...
#exec Texture Import File=Textures\Icons\WizCardSweetingBigTexture.PNG	GROUP=Icons	Name=WizCardSweetingBigTexture COMPRESSION=P8 UPSCALE=1 Mips=0 Flags=2
