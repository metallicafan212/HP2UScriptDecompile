...
#exec Texture Import File=Textures\Icons\WizCardThrustonBigTexture.PNG	GROUP=Icons	Name=WizCardThrustonBigTexture COMPRESSION=3 UPSCALE=1 Mips=0 Flags=2
