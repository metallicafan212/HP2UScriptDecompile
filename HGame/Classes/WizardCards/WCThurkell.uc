...
#exec Texture Import File=Textures\Icons\WizCardThurkellBigTexture.PNG	GROUP=Icons	Name=WizCardThurkellBigTexture COMPRESSION=3 UPSCALE=1 Mips=0 Flags=2
