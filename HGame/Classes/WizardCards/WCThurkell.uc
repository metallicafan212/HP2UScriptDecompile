...
#exec Texture Import File=Textures\Icons\WizCardThurkellBigTexture.PNG	GROUP=Icons	Name=WizCardThurkellBigTexture COMPRESSION=3 UPSCALE=1 Mips=1 Flags=2
