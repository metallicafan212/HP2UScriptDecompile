...
#exec Texture Import File=Textures\Icons\WizCardToothillBigTexture.PNG	GROUP=Icons	Name=WizCardToothillBigTexture COMPRESSION=P8 UPSCALE=1 Mips=0 Flags=2
