...
#exec Texture Import File=Textures\Icons\WizCardTremlettBigTexture.PNG	GROUP=Icons	Name=WizCardTremlettBigTexture COMPRESSION=P8 UPSCALE=1 Mips=0 Flags=2
