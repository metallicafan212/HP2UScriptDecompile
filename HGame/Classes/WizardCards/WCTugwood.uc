...
#exec Texture Import File=Textures\Icons\WizCardTugwoodBigTexture.PNG	GROUP=Icons	Name=WizCardTugwoodBigTexture COMPRESSION=P8 UPSCALE=1 Mips=0 Flags=2
