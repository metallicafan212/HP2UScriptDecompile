...
#exec Texture Import File=Textures\Icons\WizCardVablatskyBigTexture.PNG	GROUP=Icons	Name=WizCardVablatskyBigTexture COMPRESSION=3 UPSCALE=1 Mips=1 Flags=2
