...
#exec Texture Import File=Textures\Icons\WizCardWagtailBigTexture.PNG	GROUP=Icons	Name=WizCardWagtailBigTexture COMPRESSION=P8 UPSCALE=1 Mips=0 Flags=2
