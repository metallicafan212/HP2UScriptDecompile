...
#exec Texture Import File=Textures\Icons\WizCardWarbeckBigTexture.PNG	GROUP=Icons	Name=WizCardWarbeckBigTexture COMPRESSION=P8 UPSCALE=1 Mips=0 Flags=2
