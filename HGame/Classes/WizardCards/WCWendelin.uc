...
#exec Texture Import File=Textures\Icons\WizCardWendelinBigTexture.PNG	GROUP=Icons	Name=WizCardWendelinBigTexture COMPRESSION=3 UPSCALE=1 Mips=0 Flags=2
