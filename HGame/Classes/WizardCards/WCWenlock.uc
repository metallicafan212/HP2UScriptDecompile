...
#exec Texture Import File=Textures\Icons\WizCardWenlockBigTexture.PNG	GROUP=Icons	Name=WizCardWenlockBigTexture COMPRESSION=P8 UPSCALE=1 Mips=0 Flags=2
