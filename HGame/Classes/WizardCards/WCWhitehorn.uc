...
#exec Texture Import File=Textures\Icons\WizCardWhitehornBigTexture.PNG	GROUP=Icons	Name=WizCardWhitehornBigTexture COMPRESSION=3 UPSCALE=1 Mips=0 Flags=2
