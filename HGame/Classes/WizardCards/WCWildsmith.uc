...
#exec Texture Import File=Textures\Icons\WizCardWildsmithBigTexture.PNG	GROUP=Icons	Name=WizCardWildsmithBigTexture COMPRESSION=3 UPSCALE=1 Mips=1 Flags=2
