...
#exec Texture Import File=Textures\Icons\WizCardWintringhamBigTexture.PNG	GROUP=Icons	Name=WizCardWintringhamBigTexture COMPRESSION=3 UPSCALE=1 Mips=0 Flags=2
