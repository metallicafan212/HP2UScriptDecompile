...
#exec Texture Import File=Textures\Icons\WizCardWintringhamBigTexture.PNG	GROUP=Icons	Name=WizCardWintringhamBigTexture COMPRESSION=P8 UPSCALE=1 Mips=0 Flags=2
