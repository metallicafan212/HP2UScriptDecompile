...
#exec Texture Import File=Textures\Icons\WizCardWithersBigTexture.PNG	GROUP=Icons	Name=WizCardWithersBigTexture COMPRESSION=P8 UPSCALE=1 Mips=0 Flags=2
