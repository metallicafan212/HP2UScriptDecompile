...
#exec Texture Import File=Textures\Icons\WizCardWoodcroftBigTexture.PNG	GROUP=Icons	Name=WizCardWoodcroftBigTexture COMPRESSION=3 UPSCALE=1 Mips=0 Flags=2
