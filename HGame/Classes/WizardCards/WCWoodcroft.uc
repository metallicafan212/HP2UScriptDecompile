...
#exec Texture Import File=Textures\Icons\WizCardWoodcroftBigTexture.PNG	GROUP=Icons	Name=WizCardWoodcroftBigTexture COMPRESSION=P8 UPSCALE=1 Mips=0 Flags=2
