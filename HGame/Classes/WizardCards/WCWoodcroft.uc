...
#exec Texture Import File=Textures\Icons\WizCardWoodcroftBigTexture.PNG	GROUP=Icons	Name=WizCardWoodcroftBigTexture COMPRESSION=3 UPSCALE=1 Mips=1 Flags=2
