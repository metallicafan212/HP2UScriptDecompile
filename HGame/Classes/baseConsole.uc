...
function DrawLevelAction (Canvas C)
{
	...
	if ( (Viewport.Actor.Level.Pauser != "") && (Viewport.Actor.Level.LevelAction == 0) )
	{
		C.Font = C.MedFont;
	...
	if ( Viewport.Actor.Level.LevelAction == 0 )
	{
		BigMessage = "";
		return;
	}	
	else if ( Viewport.Actor.Level.LevelAction == 1 || Viewport.Actor.bShowLoadingScreen )
	{
	...
	else if ( Viewport.Actor.Level.LevelAction == 2 )
    {
		BigMessage = Localize("all","Options_0057","HPMenu");
    } 
	else if ( Viewport.Actor.Level.LevelAction == 3 )
	{
		BigMessage = ConnectingMessage;
    } 
	else if ( Viewport.Actor.Level.LevelAction == 4 )
	{
