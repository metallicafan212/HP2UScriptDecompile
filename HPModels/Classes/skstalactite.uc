...
class skstalactite extends HPMesh
  Abstract;
  
//model import (skstalactiteMesh) -AdamJD 
...
//anim import (skstalactiteAnims) -AdamJD 
...
//texture import (skstalactiteTex0) -AdamJD 
#exec Texture Import File=Textures\skstalactiteTex0.png Name=skstalactiteTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
