...
class Cauldron_Violet extends CauldronFX;
...
defaultproperties
{
    ...
    ColorStart=(Base=(R=102,G=49,B=202,A=0),Rand=(R=0,G=0,B=0,A=0))
    ...
    Textures=FireTexture'HPParticle.hp_fx.Particles.SpinV'
