...
#exec Texture Import File=Textures\skBoomSlangTex0.png Name=skBoomSlangTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=2 Group=Skins 
#exec MeshMap SetTexture MeshMap=skBoomSlangMesh Num=0 Texture=skBoomSlangTex0

//texture import (skBoomSlangTex1) -AdamJD 
#exec Texture Import File=Textures\skBoomSlangTex1.png Name=skBoomSlangTex1 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=2 Group=Skins 
