...
#exec Texture Import File=Textures\skChairsHagridsWoodTex0.png Name=skChairsHagridsWoodTex0 COMPRESSION=P8 UPSCALE=1 Mips=1 Flags=2 MaskedOverride=(R=0,G=0,B=0,A=255) Group=Skins 
...
#exec Texture Import File=Textures\skChairsHagridsWoodTex1.png Name=skChairsHagridsWoodTex1 COMPRESSION=P8 UPSCALE=1 Mips=1 Flags=2 MaskedOverride=(R=0,G=0,B=0,A=255) Group=Skins 
