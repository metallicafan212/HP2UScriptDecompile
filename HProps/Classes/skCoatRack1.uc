...
#exec Texture Import File=Textures\skCoatRack1Tex0.png Name=skCoatRack1Tex0 COMPRESSION=0 UPSCALE=1 Mips=1 Flags=2 Group=Skins 
#exec MeshMap SetTexture MeshMap=skCoatRack1Mesh Num=0 Texture=skCoatRack1Tex0

//texture import (skCoatRack1Tex1) -AdamJD 
#exec Texture Import File=Textures\skCoatRack1Tex1.png Name=skCoatRack1Tex1 COMPRESSION=0 UPSCALE=1 Mips=1 Flags=2 Group=Skins 
