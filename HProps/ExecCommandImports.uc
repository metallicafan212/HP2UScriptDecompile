//this is just a temp file to have all the exec commands in one place, the file does not get compiled -AdamJD 


//------------------------------------------------------------------------------------------------------------------------------------------------ 
//the model import exec commands 
//------------------------------------------------------------------------------------------------------------------------------------------------ 

//model import (skArmoireMesh) -AdamJD 
#exec Mesh ModelImport Mesh=skArmoireMesh ModelFile=Models\skArmoireMesh.psk LODStyle=10 
...
//model import (skBeanMauveMesh) -AdamJD 
#exec Mesh ModelImport Mesh=skBeanMauveMesh ModelFile=Models\skBeanMauveMesh.psk LODStyle=10 
...
//model import (skChairLeatherSlytherinMesh) -AdamJD 
#exec Mesh ModelImport Mesh=skChairLeatherSlytherinMesh ModelFile=Models\skChairLeatherSlytherinMesh.psk LODStyle=10 
...
//model import (skDiffindoRope64Mesh) -AdamJD 
#exec Mesh ModelImport Mesh=skDiffindoRope64Mesh ModelFile=Models\skDiffindoRope64Mesh.psk LODStyle=10 
...
//model import (skEaselMesh) -AdamJD 
#exec Mesh ModelImport Mesh=skEaselMesh ModelFile=Models\skEaselMesh.psk LODStyle=10 
...
#exec Mesh Origin Mesh=skRedBlackStripeBeanMesh X=0 Y=0 Z=0 Yaw=0 Pitch=0 Roll=0 
...
#exec Mesh Origin Mesh=skSpottedJellyBeanMesh X=0 Y=0 Z=0 Yaw=0 Pitch=0 Roll=0 
...
//------------------------------------------------------------------------------------------------------------------------------------------------ 
//the anim import exec commands 
//------------------------------------------------------------------------------------------------------------------------------------------------ 

//anim import (skArmoireAnims) -AdamJD 
#exec Anim Import Anim=skArmoireAnims AnimFile=Models\skArmoireAnims.psa Compress=1 MaxKeys=999999 ImportSeqs=1 
...
//anim import (skBeanMauveAnims) -AdamJD 
#exec Anim Import Anim=skBeanMauveAnims AnimFile=Models\skBeanMauveAnims.psa Compress=1 MaxKeys=999999 ImportSeqs=1 
...
//anim import (skChairLeatherSlytherinAnims) -AdamJD 
#exec Anim Import Anim=skChairLeatherSlytherinAnims AnimFile=Models\skChairLeatherSlytherinAnims.psa Compress=1 MaxKeys=999999 ImportSeqs=1 
...
//anim import (skDiffindoRope64Anims) -AdamJD 
#exec Anim Import Anim=skDiffindoRope64Anims AnimFile=Models\skDiffindoRope64Anims.psa Compress=1 MaxKeys=999999 ImportSeqs=1 
...
//anim import (skEaselAnims) -AdamJD 
#exec Anim Import Anim=skEaselAnims AnimFile=Models\skEaselAnims.psa Compress=1 MaxKeys=999999 ImportSeqs=1 
...
#exec MeshMap Scale MeshMap=skSnakeRayMesh X=1.0 Y=1.0 Z=1.0 
...
//------------------------------------------------------------------------------------------------------------------------------------------------ 
//the texture import exec commands 
//------------------------------------------------------------------------------------------------------------------------------------------------ 

//texture import (skArmoireTex0) -AdamJD 
#exec Texture Import File=Textures\skArmoireTex0.png Name=skArmoireTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
#exec MeshMap SetTexture MeshMap=skArmoireMesh Num=0 Texture=skArmoireTex0

//texture import (skArmorHelmetTex0) -AdamJD 
#exec Texture Import File=Textures\skArmorHelmetTex0.png Name=skArmorHelmetTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=536870914 Group=Skins 
...
#exec Texture Import File=Textures\skBathroomSinkTex0.png Name=skBathroomSinkTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=536870914 Group=Skins 
...
#exec MeshMap SetTexture MeshMap=skBeanBlackMesh Num=0 Texture=skBeanBlackTex0
...
#exec MeshMap SetTexture MeshMap=skBeanBlueSpotMesh Num=0 Texture=skBeanBlueSpotTex0
...
#exec MeshMap SetTexture MeshMap=skBeanBogieMesh Num=0 Texture=skBeanBogieTex0
...
#exec MeshMap SetTexture MeshMap=skBeanDarkGreenMesh Num=0 Texture=skBeanDarkGreenTex0
...
//texture import (skBeanMauveTex0) -AdamJD 
#exec Texture Import File=Textures\skBeanMauveTex0.png Name=skBeanMauveTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec MeshMap SetTexture MeshMap=skBeanPurpleMesh Num=0 Texture=skBeanPurpleTex0
...
#exec MeshMap SetTexture MeshMap=skBeanRedMesh Num=0 Texture=skBeanRedTex0
...
#exec Texture Import File=Textures\skBedGryffindorTex0.png Name=skBedGryffindorTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skBedInfirmaryTex0.png Name=skBedInfirmaryTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skBedInfirmaryTex1.png Name=skBedInfirmaryTex1 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skBookcaseGlassDoorsTex0.png Name=skBookcaseGlassDoorsTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skBooksOwlBookendBooksTex0.png Name=skBooksOwlBookendBooksTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skBooksPeevesThrowTex0.png Name=skBooksPeevesThrowTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skBooksSmallBookTex0.png Name=skBooksSmallBookTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skBoomSlangTex0.png Name=skBoomSlangTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
#exec MeshMap SetTexture MeshMap=skBoomSlangMesh Num=0 Texture=skBoomSlangTex0

//texture import (skBoomSlangTex1) -AdamJD 
#exec Texture Import File=Textures\skBoomSlangTex1.png Name=skBoomSlangTex1 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skBugCaveTex0.png Name=skBugCaveTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=536870914 Group=Skins 
...
#exec Texture Import File=Textures\skCabinetSupplyCaseTex0.png Name=skCabinetSupplyCaseTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skCandlesWallSingleCandleTex0.png Name=skCandlesWallSingleCandleTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skCandlesWallTripleCandleTex0.png Name=skCandlesWallTripleCandleTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skCauldronTeacherTex0.png Name=skCauldronTeacherTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
//texture import (skChairLeatherSlytherinTex0) -AdamJD 
#exec Texture Import File=Textures\skChairLeatherSlytherinTex0.png Name=skChairLeatherSlytherinTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skChallengeStarTex0.png Name=skChallengeStarTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skChandalierSingleTierTex0.png Name=skChandalierSingleTierTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=536870914 Group=Skins 
...
#exec Texture Import File=Textures\skChandalierThreeTierTex0.png Name=skChandalierThreeTierTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=536870914 Group=Skins 
...
#exec Texture Import File=Textures\skChandalierTwoTierTex0.png Name=skChandalierTwoTierTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=536870914 Group=Skins 
...
#exec Texture Import File=Textures\skChocolateFrogTex0.png Name=skChocolateFrogTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skChristmasTreeTex0.png Name=skChristmasTreeTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skCoatRack1Tex0.png Name=skCoatRack1Tex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=536870914 Group=Skins 
#exec MeshMap SetTexture MeshMap=skCoatRack1Mesh Num=0 Texture=skCoatRack1Tex0

//texture import (skCoatRack1Tex1) -AdamJD 
#exec Texture Import File=Textures\skCoatRack1Tex1.png Name=skCoatRack1Tex1 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=536870914 Group=Skins 
...
#exec Texture Import File=Textures\skCrystalBallTex0.png Name=skCrystalBallTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skCutSceneMarkerTex0.png Name=skCutSceneMarkerTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
//texture import (skDiffindoRope64Tex0) -AdamJD 
#exec Texture Import File=Textures\skDiffindoRope64Tex0.png Name=skDiffindoRope64Tex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skDishesGobletTex0.png Name=skDishesGobletTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skDishesHagridTeaCupTex0.png Name=skDishesHagridTeaCupTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skDishesHagridTeaCupTex1.png Name=skDishesHagridTeaCupTex1 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skDishesHagridTeaPotTex0.png Name=skDishesHagridTeaPotTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skDishesHagridTeaPotTex1.png Name=skDishesHagridTeaPotTex1 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skDragonSkeletonTex0.png Name=skDragonSkeletonTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skDragonSkeletonTex1.png Name=skDragonSkeletonTex1 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skDragonSkeletonTex2.png Name=skDragonSkeletonTex2 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skDragonSkeletonTex3.png Name=skDragonSkeletonTex3 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skDragonSkullTex0.png Name=skDragonSkullTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skEaselATex0.png Name=skEaselATex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
#exec MeshMap SetTexture MeshMap=skEaselAMesh Num=0 Texture=skEaselATex0

//texture import (skEaselBTex0) -AdamJD 
#exec Texture Import File=Textures\skEaselBTex0.png Name=skEaselBTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
#exec MeshMap SetTexture MeshMap=skEaselBMesh Num=0 Texture=skEaselBTex0

//texture import (skEaselTex0) -AdamJD 
#exec Texture Import File=Textures\skEaselTex0.png Name=skEaselTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
#exec MeshMap SetTexture MeshMap=skEaselMesh Num=0 Texture=skEaselTex0

//texture import (skfacestatueTex0) -AdamJD 
#exec Texture Import File=Textures\skfacestatueTex0.png Name=skfacestatueTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skFlipendoVaseBronzeBrokenTex0.png Name=skFlipendoVaseBronzeBrokenTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skFlipendoVaseBronzeTex0.png Name=skFlipendoVaseBronzeTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skFlipendoVaseGreenBrokenTex0.png Name=skFlipendoVaseGreenBrokenTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skFlipendoVaseGreenTex0.png Name=skFlipendoVaseGreenTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skFlipendoVaseMingBrokenTex0.png Name=skFlipendoVaseMingBrokenTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skFlipendoVaseMingTex0.png Name=skFlipendoVaseMingTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skFoodPeevesAppleTex0.png Name=skFoodPeevesAppleTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skFordAngliaDamagedLowTex0.png Name=skFordAngliaDamagedLowTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skFordAngliaDamagedLowTex1.png Name=skFordAngliaDamagedLowTex1 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skFordAngliaDamagedTex0.png Name=skFordAngliaDamagedTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skFordAngliaDamagedTex1.png Name=skFordAngliaDamagedTex1 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skFordAngliaTex0.png Name=skFordAngliaTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
#exec MeshMap SetTexture MeshMap=skFordAngliaMesh Num=0 Texture=skFordAngliaTex0

//texture import (skFordAngliaTex1) -AdamJD 
#exec Texture Import File=Textures\skFordAngliaTex1.png Name=skFordAngliaTex1 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
#exec MeshMap SetTexture MeshMap=skFordAngliaMesh Num=1 Texture=skFordAngliaTex1

//texture import (skFramesEmptyTex0) -AdamJD 
#exec Texture Import File=Textures\skFramesEmptyTex0.png Name=skFramesEmptyTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
#exec MeshMap SetTexture MeshMap=skFramesEmptyMesh Num=0 Texture=skFramesEmptyTex0

//texture import (skGnomeHomeTex0) -AdamJD 
#exec Texture Import File=Textures\skGnomeHomeTex0.png Name=skGnomeHomeTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
#exec MeshMap SetTexture MeshMap=skGnomeHomeMesh Num=0 Texture=skGnomeHomeTex0

//texture import (skGnomeHomeTex1) -AdamJD 
#exec Texture Import File=Textures\skGnomeHomeTex1.png Name=skGnomeHomeTex1 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skhanginglampGSTex0.png Name=skhanginglampGSTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skharrybedTex0.png Name=skharrybedTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
#exec MeshMap SetTexture MeshMap=skharrybedMesh Num=0 Texture=skharrybedTex0

//texture import (skHogFrontTorchTex0) -AdamJD 
#exec Texture Import File=Textures\skHogFrontTorchTex0.png Name=skHogFrontTorchTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skHutchHagridTex0.png Name=skHutchHagridTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
#exec MeshMap SetTexture MeshMap=skHutchHagridMesh Num=0 Texture=skHutchHagridTex0

//texture import (skHutchHagridTex1) -AdamJD 
#exec Texture Import File=Textures\skHutchHagridTex1.png Name=skHutchHagridTex1 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skImpHomeTex0.png Name=skImpHomeTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
#exec MeshMap SetTexture MeshMap=skImpHomeMesh Num=0 Texture=skImpHomeTex0

//texture import (skImpHomeTex1) -AdamJD 
#exec Texture Import File=Textures\skImpHomeTex1.png Name=skImpHomeTex1 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
#exec MeshMap SetTexture MeshMap=skImpHomeMesh Num=1 Texture=skImpHomeTex1

//texture import (skImpHomeTex2) -AdamJD 
#exec Texture Import File=Textures\skImpHomeTex2.png Name=skImpHomeTex2 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skJarPotionGreenTex0.png Name=skJarPotionGreenTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skKnightTex0.png Name=skKnightTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skLampEntranceTex0.png Name=skLampEntranceTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
#exec MeshMap SetTexture MeshMap=skLampEntranceMesh Num=0 Texture=skLampEntranceTex0

//texture import (skLampWallTex0) -AdamJD 
#exec Texture Import File=Textures\skLampWallTex0.png Name=skLampWallTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=536870914 Group=Skins 
...
#exec Texture Import File=Textures\skLockhartSt01Tex0.png Name=skLockhartSt01Tex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skLockhartSt01Tex1.png Name=skLockhartSt01Tex1 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skLockhartSt02Tex0.png Name=skLockhartSt02Tex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skLockhartSt02Tex1.png Name=skLockhartSt02Tex1 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skLockhartSt03Tex0.png Name=skLockhartSt03Tex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skLockhartSt03Tex1.png Name=skLockhartSt03Tex1 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skLockhartSt04Tex0.png Name=skLockhartSt04Tex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skLockhartSt04Tex1.png Name=skLockhartSt04Tex1 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skLockhartSt05Tex0.png Name=skLockhartSt05Tex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skLockhartSt05Tex1.png Name=skLockhartSt05Tex1 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skLockhartSt06Tex0.png Name=skLockhartSt06Tex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skLockhartSt06Tex1.png Name=skLockhartSt06Tex1 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skLockhartSt07Tex0.png Name=skLockhartSt07Tex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skLockhartSt07Tex1.png Name=skLockhartSt07Tex1 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skLockhartSt08Tex0.png Name=skLockhartSt08Tex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skLockhartSt08Tex1.png Name=skLockhartSt08Tex1 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skMrytleSinkTex0.png Name=skMrytleSinkTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skNorrisTorchTex0.png Name=skNorrisTorchTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
#exec MeshMap SetTexture MeshMap=skNorrisTorchMesh Num=0 Texture=skNorrisTorchTex0

//texture import (skPadlockTex0) -AdamJD 
#exec Texture Import File=Textures\skPadlockTex0.png Name=skPadlockTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skPlantsCactus1Tex0.png Name=skPlantsCactus1Tex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=536870914 Group=Skins 
...
#exec Texture Import File=Textures\skPlantsHangingPlant1Tex0.png Name=skPlantsHangingPlant1Tex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=536870914 Group=Skins 
...
#exec Texture Import File=Textures\skQuidArmorTex0.png Name=skQuidArmorTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skRedBlackStripeBeanTex0.png Name=skRedBlackStripeBeanTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skRiddlesDiaryTex0.png Name=skRiddlesDiaryTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
#exec MeshMap SetTexture MeshMap=skRiddlesDiaryMesh Num=0 Texture=skRiddlesDiaryTex0

//texture import (skRopeTex0) -AdamJD 
#exec Texture Import File=Textures\skRopeTex0.png Name=skRopeTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
#exec MeshMap SetTexture MeshMap=skRopeMesh Num=0 Texture=skRopeTex0

//texture import (skSalazarTex0) -AdamJD 
#exec Texture Import File=Textures\skSalazarTex0.png Name=skSalazarTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
#exec MeshMap SetTexture MeshMap=skSalazarMesh Num=0 Texture=skSalazarTex0

//texture import (skSalazarTex1) -AdamJD 
#exec Texture Import File=Textures\skSalazarTex1.png Name=skSalazarTex1 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
#exec MeshMap SetTexture MeshMap=skSalazarMesh Num=1 Texture=skSalazarTex1

//texture import (skSalazarTex2) -AdamJD 
#exec Texture Import File=Textures\skSalazarTex2.png Name=skSalazarTex2 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
#exec MeshMap SetTexture MeshMap=skSalazarMesh Num=2 Texture=skSalazarTex2

//texture import (skSalazarTex3) -AdamJD 
#exec Texture Import File=Textures\skSalazarTex3.png Name=skSalazarTex3 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skShowerHeadTex0.png Name=skShowerHeadTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skSignsArrowFlipendoTex0.png Name=skSignsArrowFlipendoTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skSnakeRayTex0.png Name=skSnakeRayTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
#exec MeshMap SetTexture MeshMap=skSnakeRayMesh Num=0 Texture=skSnakeRayTex0

//texture import (skSpellBallTex0) -AdamJD 
#exec Texture Import File=Textures\skSpellBallTex0.png Name=skSpellBallTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skStatueGregorySmarmyTex0.png Name=skStatueGregorySmarmyTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skStatueHunchbackWitchTex0.png Name=skStatueHunchbackWitchTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skStatueHunchbackWitchTex1.png Name=skStatueHunchbackWitchTex1 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skStatueOwlTex0.png Name=skStatueOwlTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skSundialTex0.png Name=skSundialTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\sktablelampTex0.png Name=sktablelampTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skTableTrestleTex0.png Name=skTableTrestleTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=536870914 Group=Skins 
...
#exec Texture Import File=Textures\skTableWoodRectangle1Tex0.png Name=skTableWoodRectangle1Tex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=536870914 Group=Skins 
...
#exec Texture Import File=Textures\skTableWoodRectangle2Tex0.png Name=skTableWoodRectangle2Tex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skTelescopeTex0.png Name=skTelescopeTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skToolsWateringCanTex0.png Name=skToolsWateringCanTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\skTrunkTex0.png Name=skTrunkTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
#exec MeshMap SetTexture MeshMap=skTrunkMesh Num=0 Texture=skTrunkTex0

//texture import (skVaseUrnTex0) -AdamJD 
#exec Texture Import File=Textures\skVaseUrnTex0.png Name=skVaseUrnTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=536870914 Group=Skins 
...
#exec Texture Import File=Textures\skwallsconceChTex0.png Name=skwallsconceChTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
...
#exec Texture Import File=Textures\WizardCardIconTex0.png Name=WizardCardIconTex0 COMPRESSION=3 UPSCALE=1 Mips=1 Flags=0 Group=Skins 
#exec MeshMap SetTexture MeshMap=WizardCardIconMesh Num=0 Texture=WizardCardIconTex0
