...
var Texture		MenuTLTexture;
var Texture 	MenuTTexture;
var Texture 	MenuTRTexture;
var Texture 	MenuBLTexture;
var Texture 	MenuBTexture;
var Texture 	MenuBRTexture;
var Texture		MenuLTexture;
var Texture		MenuRTexture;
var Texture		MenuAreaTexture;
var Texture		MenuHighlightTexture;
var Texture		ChkCheckedTexture;
var Texture		ChkCheckedDisabledTexture;
var Texture		ChkUncheckedTexture;
var Texture		ChkUncheckedDisabledTexture;
var Texture		MenuBarTexture;
var Texture		MenuHighlightLTexture;
var Texture		MenuHighlightRTexture;
var Texture		MenuHighlightMTexture;
...
function ComboList_DrawBackground(UWindowComboList W, Canvas C)
{
	...
	*/
	...
	W.DrawClippedTexture(C, 0, 0, MenuTLTexture);
	W.DrawStretchedTexture(C, 4, 0, W.WinWidth-8, 4, MenuTTexture);
	W.DrawClippedTexture(C, W.WinWidth-4, 0, MenuTRTexture);

	W.DrawClippedTexture(C, 0, W.WinHeight-4, MenuBLTexture);
	W.DrawStretchedTexture(C, 4, W.WinHeight-4, W.WinWidth-8, 4, MenuBTexture);
	W.DrawClippedTexture(C, W.WinWidth-4, W.WinHeight-4, MenuBRTexture);

	W.DrawStretchedTexture(C, 0, 4, 4, W.WinHeight-8, MenuLTexture);
	W.DrawStretchedTexture(C, W.WinWidth-4, 4, 4, W.WinHeight-8, MenuRTexture);

	W.DrawStretchedTexture(C, 4, 4, W.WinWidth-8, W.WinHeight-8, MenuAreaTexture);
}
...
function ComboList_DrawItem(UWindowComboList Combo, Canvas C, float X, float Y, float W, float H, string Text, bool bSelected)
{
	...
	if(bSelected)
	{
		...
		Combo.DrawStretchedTexture(C, X, Y, W, H, MenuHighlightTexture);
		C.DrawColor.R = 0;
		C.DrawColor.G = 0;
		C.DrawColor.B = 0;
	}
...
function Checkbox_SetupSizes(UWindowCheckbox W, Canvas C)
{
	...
	if(W.bChecked) 
	{
		...
		W.UpTexture = ChkCheckedTexture;
		W.DownTexture = ChkCheckedTexture;
		W.OverTexture = ChkCheckedTexture;
		W.DisabledTexture = ChkCheckedDisabledTexture;
	}
	else 
	{
		...
		W.UpTexture = ChkUncheckedTexture;
		W.DownTexture = ChkUncheckedTexture;
		W.OverTexture = ChkUncheckedTexture;
		W.DisabledTexture = ChkUncheckedDisabledTexture;
	}
}
...
function Menu_DrawMenuBar(UWindowMenuBar W, Canvas C)
{
	...
	W.DrawStretchedTexture( C, 16, 0, W.WinWidth - 32, 16, MenuBarTexture);
}
...
function Menu_DrawMenuBarItem(UWindowMenuBar B, UWindowMenuBarItem I, float X, float Y, float W, float H, Canvas C)
{
	if(B.Selected == I)
	{
		...
		B.DrawClippedTexture(C, X, 1, MenuHighlightLTexture);
		B.DrawClippedTexture(C, X+W-1, 1, MenuHighlightRTexture);
		B.DrawStretchedTexture(C, X+1, 1, W-2, 16, MenuHighlightMTexture);
	}
...
function Menu_DrawPulldownMenuBackground(UWindowPulldownMenu W, Canvas C)
{
	...
	*/
	...
	W.DrawClippedTexture(C, 0, 0, MenuTLTexture);
	W.DrawStretchedTexture(C, 2, 0, W.WinWidth-4, 2, MenuTTexture);
	W.DrawClippedTexture(C, W.WinWidth-2, 0, MenuTRTexture);

	W.DrawClippedTexture(C, 0, W.WinHeight-2, MenuBLTexture);
	W.DrawStretchedTexture(C, 2, W.WinHeight-2, W.WinWidth-4, 2, MenuBTexture);
	W.DrawClippedTexture(C, W.WinWidth-2, W.WinHeight-2, MenuBRTexture);

	W.DrawStretchedTexture(C, 0, 2, 2, W.WinHeight-4, MenuLTexture);
	W.DrawStretchedTexture(C, W.WinWidth-2, 2, 2, W.WinHeight-4, MenuRTexture);
	W.DrawStretchedTexture(C, 2, 2, W.WinWidth-4, W.WinHeight-4, MenuAreaTexture);
}
...
function Menu_DrawPulldownMenuItem(UWindowPulldownMenu M, UWindowPulldownMenuItem Item, Canvas C, float X, float Y, float W, float H, bool bSelected)
{
	...
	if(bSelected)
		...
		M.DrawStretchedTexture(C, X, Y, W, H, MenuHighlightTexture);
...
defaultproperties 
{
	...
	//find the other textures -AdamJD
	ChkCheckedTexture=ChkChecked
	ChkUncheckedTexture=ChkUnchecked
	ChkCheckedDisabledTexture=ChkCheckedDisabled
	ChkUncheckedDisabledTexture=ChkUncheckedDisabled
	MenuBarTexture=MenuBar
	MenuHighlightLTexture=MenuHighlightL
	MenuHighlightMTexture=MenuHighlightM
	MenuHighlightRTexture=MenuHighlightR
	MenuAreaTexture=MenuArea
	MenuTLTexture=MenuTL
	MenuTTexture=MenuT
	MenuTRTexture=MenuTR
	MenuLTexture=MenuL
	MenuRTexture=MenuR
	MenuBLTexture=MenuBL
	MenuBTexture=MenuB
	MenuBRTexture=MenuBR
	MenuHighlightTexture=MenuHighlight
